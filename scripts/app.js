...
define(['jquery', 'underscore', 'backbone', 'buzz', 'localStorage',  'transform', 'easing', 'bootstrap'], function ($, _, Backbone, buzz) {
    ...
    var Roulette = function () {
        ...
        this.awards = this._awards = [
            ...
            {pt: 3, sku: 'ceenee_cutee', name:"CuTee",chance:10,amount:2, src: 'cutee.jpg', w: 40},
            ...
            {pt: 11, sku: 'lee_coffee', name:"Coffee from Lee Sandwiches",chance:70,amount:210, src: 'lee_coffee.png', w: 120
              ,inner_gift: [
                {amount: 50, name: '$20 coupons for Lee\'s Tax & Financial.'}, 
                {amount: 160, name: 'Lee Sandwiches Coffee Coupon'}
              ] 
            },
